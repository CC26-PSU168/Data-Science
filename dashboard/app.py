...
PLOTLY_LAYOUT = dict(
    ...
    xaxis=dict(gridcolor="#1f2937", zerolinecolor="#1f2937", tickfont=dict(color="#64748b")),
    yaxis=dict(gridcolor="#1f2937", zerolinecolor="#1f2937", tickfont=dict(color="#64748b")),
)
...
with tab1:
    ...
    with col_l:
        ...
        fig_trend.update_layout(**PLOTLY_LAYOUT,
            ...
            yaxis=dict(tickformat=".2s", gridcolor="#1f2937", zerolinecolor="#1f2937",
                       tickprefix="Rp ", tickfont=dict(color="#64748b")),
            xaxis=dict(gridcolor="#1f2937", tickfont=dict(color="#64748b", size=10))
        )
...
with tab2:
    ...
    with c1:
        ...
        fig_bar.update_layout(**PLOTLY_LAYOUT, height=320,
            xaxis=dict(tickformat=".2s", tickprefix="Rp ", gridcolor="#1f2937",
    ...
    with c2:
        ...
        fig_day.update_layout(**PLOTLY_LAYOUT, height=320,
            yaxis=dict(tickformat=".2s", tickprefix="Rp ", gridcolor="#1f2937",
                       tickfont=dict(color="#64748b")),
        )
